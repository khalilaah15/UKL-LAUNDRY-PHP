...
if($_POST){
    ...
    $role=$_POST['role'];
    if(empty($nama_user)){
        echo "<script>alert('nama pengguna tidak boleh kosong');location.href='tambah_user.php';</script>";
        ...
        if($insert){
            echo "<script>alert('Sukses menambahkan pengguna');location.href='user.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan pengguna');location.href='tambah_user.php';</script>";
        }
    }
}
?>
