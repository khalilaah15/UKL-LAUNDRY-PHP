...
echo "<script>alert('Sukses mengupdate status Paket');location.href='transaksi.php';</script>";
} else {
    echo "<script>alert('Gagal mengupdate status Paket');location.herf='transaksi.php';</script>";
}
